...
GO
PRINT N'Creating Table [dbo].[RentalDetail]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_RentalDetail_RentalId]...';


GO
ALTER TABLE [dbo].[RentalDetail]
    ADD CONSTRAINT [FK_RentalDetail_RentalId] FOREIGN KEY ([RentalId]) REFERENCES [dbo].[Rental] ([Id]);
